...
export function ImageRecordingControls({buttonProps, setRecordingPerson, setIsShowImageCount, errorMessage, setErrorMessage, fetchPeopleFn, addPeopleFn}: Props) {
